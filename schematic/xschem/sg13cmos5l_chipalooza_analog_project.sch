...
T {SPARE - reference moved to the clk pin} 370 -728 0 0 0.25 0.25 {}
...
FB_CLK leaves the block.
  ...
  REF_CLK   clk             the harness clock pin, shared with the pattern
                            generator.  proj_clk = select & clk, so an
                            unselected project sees no reference at all.
...
N 1000 -1080 1500 -1080 {lab=clk}
N 1000 -1080 1000 -720 {lab=clk}
C {lab_wire.sym} 1000 -1080 0 0 {name=w_refclk sig_type=std_logic lab=clk}
...
N 740 -720 800 -720 {lab=analog_pin[0]}
C {lab_pin.sym} 800 -720 0 1 {name=lp_analog_pin_0 sig_type=std_logic lab=analog_pin[0]}
