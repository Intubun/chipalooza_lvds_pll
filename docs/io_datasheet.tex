...
\begin{equation*}
  f_{\mathrm{VCO}} = f_{\mathrm{clk}} \times \mathtt{DIV\_RATIO}
  \qquad
...
$f_{\mathrm{clk}} \times \mathtt{DIV\_RATIO} / 2$. The ring oscillator covers
...
\midrule
Differential output   & $|V_{OD}|$      & 380.5 & {247\,\ldots\,454} & TIA/EIA-644-A 4.1.1 \\
Offset voltage        & $V_{OS}$        & 1193.8 & {1125\,\ldots\,1375} & 4.1.2 \\
Offset, peak-to-peak  & $V_{OS,pp}$     & 120.4 & {< 150} & 4.1.5 \\
\addlinespace
PLL output frequency  & $f_{pll\_clk}$  & 500.0038 & {500} & target \\
Frequency error       &                 & 7.5 & {} & ppm \\
Control voltage       & $V_{CTRL}$      & 581.4 & {} & mV, settled \\
\addlinespace
Driver supply current & $I_{3v3}$       & 5.74 & {} & mA \\
Core supply current   & $I_{1v2}$       & 0.311 & {} & mA \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{$\Delta V_{OS}$ is not measured at the top level.} The
        ...
        own DC bench.
  \item \textbf{Offset margin is asymmetric.} At the \SI{1.2}{\volt} reference
        --- the nearest value on the \SI{0.3}{\volt} adjustment grid ---
        $V_{OS}$ sits \SI{69}{\milli\volt} above the lower limit and
        \SI{181}{\milli\volt} below the upper. Corner coverage is outstanding.
