...
F {}
E {}
T {PLL bench ref25_r40: 25 MHz reference in, PRBS-7 at 500 Mb/s out.

  same 1 GHz VCO again at a tenth of the compare frequency - a row of pll_integer_characterization.csv

  VCO      = REF * DIV_RATIO   = 1 GHz
  pll_clk  = VCO / 2           = 500 MHz   <- the line rate
  test_clk = VCO / 16          = 62.5 MHz   <- on analog_pin[1]

  DIV_RATIO = 40, code 320 = 0101000000
              integer part 40 in div_ratio[9:3], 0/8 in div_ratio[2:0]
...
C {devices/vsource.sym} -2000 460 0 0 {name=Vdig_in_15 value="1.2"}
N -2000 490 -2000 520 {lab=GND}
C {devices/gnd.sym} -2000 520 0 0 {name=lg_dig_in_15 lab=GND}
T {DIV_RATIO[8] = 1   weight integer 32} -1920 455 0 0 0.3 0.3 {}
...
T {DIV_RATIO = 40   code 320 = 0101000000} -2260 85 0 0 0.4 0.4 {}
...
T {TEST_DIV = 3   TEST_CLK = VCO/16} -2260 2205 0 0 0.4 0.4 {}
...
C {devices/vsource.sym} -2000 3820 0 0 {name=Vanalog_pin_0 value="PULSE(0 1.2 0 50p 50p 19.9500n 40.0000n)"}
N -2000 3850 -2000 3880 {lab=GND}
C {devices/gnd.sym} -2000 3880 0 0 {name=lg_analog_pin_0 lab=GND}
T {REF_CLK, 25 MHz} -1920 3815 0 0 0.3 0.3 {}
...
descr="Load waves"
tclcommand="xschem raw_read $netlist_dir/sg13cmos5l_chipalooza_analog_project_tb_pll_ref25_r40.raw tran"
}
