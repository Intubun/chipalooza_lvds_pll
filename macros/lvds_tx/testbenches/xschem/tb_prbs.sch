...
logy=0
hilight_wave=-1
rawfile=$netlist_dir/tb_prbs.raw}
T {tb_prbs  --  real data: a full PRBS7 period at 1 Gb/s

140 bits, so one complete period of the sequence plus a margin: every run
length PRBS7 contains appears as often as it should.

DI11 DI10 pick the length -- PRBS7 here, and 9, 15 or 31 by changing those two
sources.  PRBS31 needs a longer run than this one: it opens with 31 identical
bits, because the seed is all ones, and a short window sees no transitions at
all.

WHAT TO LOOK AT: vodmax / vodmin in the log against the 250..450 mV of clause
4.1.1, and vospp against the 150 mV of 4.1.5.  Real data is harder on Vos than
the alternating pattern the clause prescribes; that gap is a declared
deviation, docs/serdes-findings.md.
...
bench instead:
  docker exec iic-osic-tools_xserver bash -lc \\
    /foss/designs/chipalooza_lvds_pll/macros/lvds_tx/serdes/run.sh} -3500 -2540 0 0 0.4 0.4 {}
...
T {DI9 DI8 = 01  PRBS} -1900 -1420 0 0 0.3 0.3 {}
...
N -2560 -1270 -2500 -1270 {lab=0}
N -2300 -1330 -2240 -1330 {lab=Clk}
N -2360 -1270 -2300 -1270 {lab=0}
N -2100 -1330 -2040 -1330 {lab=DI12}
N -2160 -1270 -2100 -1270 {lab=0}
N -1900 -1330 -1840 -1330 {lab=DI8}
N -1960 -1270 -1900 -1270 {lab=0}
N -1700 -1330 -1640 -1330 {lab=DI9}
N -1760 -1270 -1700 -1270 {lab=0}
N -1500 -1330 -1440 -1330 {lab=DI10}
N -1560 -1270 -1500 -1270 {lab=0}
N -1300 -1330 -1240 -1330 {lab=DI11}
N -1360 -1270 -1300 -1270 {lab=0}
N -1100 -1330 -1040 -1330 {lab=DI13}
N -1160 -1270 -1100 -1270 {lab=0}
N -2500 -1030 -2440 -1030 {lab=DI7}
N -2560 -970 -2500 -970 {lab=0}
N -2300 -1030 -2240 -1030 {lab=DI6}
N -2360 -970 -2300 -970 {lab=0}
N -2100 -1030 -2040 -1030 {lab=DI5}
N -2160 -970 -2100 -970 {lab=0}
N -1900 -1030 -1840 -1030 {lab=DI4}
N -1960 -970 -1900 -970 {lab=0}
N -1700 -1030 -1640 -1030 {lab=DI3}
N -1760 -970 -1700 -970 {lab=0}
N -1500 -1030 -1440 -1030 {lab=DI2}
N -1560 -970 -1500 -970 {lab=0}
N -1300 -1030 -1240 -1030 {lab=DI1}
N -1360 -970 -1300 -970 {lab=0}
N -1100 -1030 -1040 -1030 {lab=DI0}
N -1160 -970 -1100 -970 {lab=0}
N -700 -1330 -640 -1330 {lab=Vref}
N -760 -1270 -700 -1270 {lab=0}
N -500 -1330 -440 -1330 {lab=VDDC}
N -560 -1270 -500 -1270 {lab=0}
N -300 -1330 -240 -1330 {lab=Irf_pdd}
N -360 -1270 -300 -1270 {lab=0}
N -100 -1330 -40 -1330 {lab=Irf_drvd}
N -160 -1270 -100 -1270 {lab=0}
N -2180 -250 -2140 -250 {lab=Clk}
N -2180 -230 -2140 -230 {lab=VDDC}
N -2180 -30 -2140 -30 {lab=0}
N -2180 -50 -2140 -50 {lab=0}
N -2180 -70 -2140 -70 {lab=0}
N -2180 -90 -2140 -90 {lab=0}
N -2180 -110 -2140 -110 {lab=0}
N -2180 -130 -2140 -130 {lab=0}
N -2180 -150 -2140 -150 {lab=0}
N -2180 -170 -2140 -170 {lab=0}
N -2180 -190 -2140 -190 {lab=0}
N -2180 -210 -2140 -210 {lab=0}
N -2180 250 -2140 250 {lab=DI0}
N -2180 230 -2140 230 {lab=DI1}
N -2180 210 -2140 210 {lab=DI2}
N -2180 190 -2140 190 {lab=DI3}
N -2180 170 -2140 170 {lab=DI4}
N -2180 150 -2140 150 {lab=DI5}
N -2180 130 -2140 130 {lab=DI6}
N -2180 110 -2140 110 {lab=DI7}
N -2180 90 -2140 90 {lab=DI8}
N -2180 70 -2140 70 {lab=DI9}
N -2180 50 -2140 50 {lab=DI10}
N -2180 30 -2140 30 {lab=DI11}
N -2180 10 -2140 10 {lab=DI12}
N -2180 -10 -2140 -10 {lab=DI13}
...
N -890 -50 -850 -50 {lab=Dp}
N -890 -30 -850 -30 {lab=Dn}
N -890 -10 -850 -10 {lab=Irf_pdd}
N -890 10 -850 10 {lab=Irf_drvd}
N -890 30 -850 30 {lab=Vref}
...
N 550 -70 600 -70 {lab=Vos_d}
N 600 70 650 70 {lab=Vos_d}
N 550 130 600 130 {lab=Od_n}
...
C {vsource.sym} -1900 -1300 0 0 {name=V3 value="1.2" savecurrent=false}
...
C {simulator_commands_shown.sym} -2610 -1670 0 0 {
name=SimulatorNGSPICE
simulator=ngspice
only_toplevel=false
value="
.options temp=27
.ic v(xtx.xdrv.cmfb)=1.54
.control
save all
tran 1p 1530n 0 10p
let vod = v(od_p)-v(od_n)
meas tran vodmax MAX vod from=17.0000n to=153.0000n
meas tran vodmin MIN vod from=17.0000n to=153.0000n
meas tran vosmax MAX v(vos_d) from=17.0000n to=153.0000n
meas tran vosmin MIN v(vos_d) from=17.0000n to=153.0000n
let vospp = vosmax-vosmin
print vospp
write tb_prbs.raw
.endc
"
...
descr="load waves"
tclcommand="xschem raw_read $netlist_dir/tb_prbs.raw tran"
}
